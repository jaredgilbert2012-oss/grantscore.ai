...
funded_corpus = [
    {
        ...
        "study_section": "unknown",  # fill in if you find it
        "fiscal_year": "2023",
    ...
    {
        "text": """[Abstract text from Williams/Harvard grant here]""",
        "label": "funded",
        "tier": "strong",
    ...
    {
        "text": """[Abstract text from Cohen grant here]""",
        "label": "funded",
        "tier": "strong",
        "institution": "R1 Research University",
        "study_section": "unknown",
...
funded_examples = [
    ...
    # Source: NIH Reporter | Project #: 1R01AG075927-01A1   | FY: 2023 | PI: BENNETT, DAVID ALAN
    """
    ...
    # Source: NIH Reporter | Project #: 1R01AG072641-01A1   | FY: 2022 | PI: COHEN, ANN D.
    """
    ...
    # Source: NIH Reporter | Project #: 1R01HD101351-01   | FY: 2020 | PI: WILLIAMS, PAIGE L
    """
